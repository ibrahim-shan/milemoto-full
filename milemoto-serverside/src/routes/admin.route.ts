...
import couponAdmin from './admin/coupon.route.js';
import orderAdmin from './admin/order.route.js';
import invoiceAdmin from './admin/invoice.route.js';
import orderRequestAdmin from './admin/orderRequest.route.js';
import reviewAdmin from './admin/review.route.js';
...
admin.use('/coupons', couponAdmin);
admin.use('/orders', orderAdmin);
admin.use('/invoices', invoiceAdmin);
admin.use('/order-requests', orderRequestAdmin);
admin.use('/reviews', reviewAdmin);
