...
type GradeFilterValue = string | number | boolean | string[] | undefined;

type GradeFiltersProps = {
  filters: Record<string, GradeFilterValue>;
  onFilterChange: (nextFilters: Record<string, GradeFilterValue>) => void;
  search: string;
