...
type VariantFilterValue = string | number | boolean | string[] | undefined;

type VariantFiltersProps = {
  filters: Record<string, VariantFilterValue>;
  onFilterChange: (nextFilters: Record<string, VariantFilterValue>) => void;
  search: string;
